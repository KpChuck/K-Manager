    ...
    public void decode(ResTable resTable, ExtFile apkFile, File outDir)
        ...
        for (ResPackage pkg : resTable.listMainPackages()) {
            ...
            for (ResResource res : pkg.listFiles()) {
                if (res.getFilePath().endsWith("/keyguard_user_switcher_item")) {
                    fileDecoder.decode(res, in, out);
                    LOGGER.info("Generated xml file " + res.getFilePath());
                }
            }
...
//                LOGGER.info("Generated value file " + valuesFile.getPath());
//            }
//            generatePublicXml(pkg, out, xmlSerializer);
    ...
    public void generateValuesFile(ResValuesFile valuesFile, Directory out,
    ...
    public void generatePublicXml(ResPackage pkg, Directory out,
    ...
    protected ResPackage[] getResPackagesFromApk(ExtFile apkFile,ResTable resTable, boolean keepBroken)
            throws AndrolibException {
        try {
    ...
    public File getFrameworkApk(int id, String frameTag)
        ...
        if (id == 1) {
            try (InputStream in = AndrolibResources.class.getResourceAsStream("/androlib/android-framework.jar");
    ...
    public File getAndroidResourcesFile() throws AndrolibException {
        try {
            return Jar.getResourceAsFile("/androlib/android-framework.jar");
        } catch (BrutException ex) {
            throw new AndrolibException(ex);
        }
    }
