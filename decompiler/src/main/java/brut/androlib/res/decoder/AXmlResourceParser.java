...
import androidapktool.content.res.XmlResourceParser;
...
public class AXmlResourceParser implements XmlResourceParser {
    ...
    public String getIdAttribute() {
        ...
        int value = m_attributes[offset + ATTRIBUTE_IX_VALUE_STRING];
        String id = m_strings.getString(value);
        return m_strings.getString(value);
    }
    ...
    String getNonDefaultNamespaceUri() {
    ...
    void setFirstError(AndrolibException error) {
        if (mFirstError == null) {
            mFirstError = error;
        }
    }
    ...
    static final int ATTRIBUTE_IX_NAMESPACE_URI = 0,
    ...
    static final int PRIVATE_PKG_ID = 0x7F;
}
