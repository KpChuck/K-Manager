...
public class ARSCDecoder {
    ...
    public static ARSCData decodeUntil(InputStream arscStream, boolean findFlagsOffsets, boolean keepBroken, String type)
            throws AndrolibException {
        return decodeUntil(arscStream, findFlagsOffsets, keepBroken, type, new ResTable());
    }
    ...
    public static ARSCData decodeUntil(InputStream arscStream, boolean findFlagsOffsets, boolean keepBroken, String type,
            ...
            throws AndrolibException {
        try {
            ARSCDecoder decoder = new ARSCDecoder(arscStream, resTable, findFlagsOffsets, keepBroken, type);
    ...
    public static ARSCData decode(InputStream arscStream, boolean findFlagsOffsets, boolean keepBroken,
            ...
            throws AndrolibException {
        try {
            ARSCDecoder decoder = new ARSCDecoder(arscStream, resTable, findFlagsOffsets, keepBroken, null);
            ResPackage[] pkgs = decoder.readTableHeader();
            return new ARSCData(pkgs, decoder.mFlagsOffsets == null
                    ? null
                    : decoder.mFlagsOffsets.toArray(new FlagsOffset[0]), resTable);
    ...
    private ARSCDecoder(InputStream arscStream, ResTable resTable, boolean storeFlagsOffsets, boolean keepBroken, String type) {
        typeFilter = type;
    ...
    private ResPackage readTablePackage() throws IOException, AndrolibException {
        ...
        while (mHeader.type == Header.TYPE_SPEC_TYPE) {
            readTableTypeSpec();
            if (typeFilter != null && mPkg.hasType(typeFilter))
                break;
        }
