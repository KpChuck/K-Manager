...
public class ResReferenceValue extends ResIntValue {
    ...
    public String getReferentName() throws AndrolibException {
        try {
            Resources res = mPackage.getResTable().getPackageManager().getResourcesForApplication(mPackage.getName());
            return res.getResourceEntryName(mValue);
