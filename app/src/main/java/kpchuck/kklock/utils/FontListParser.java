...
public final class FontListParser {
    ...
    public static ArrayMap<String, Integer> TYPES;
    static {
        TYPES = new ArrayMap<>();
        TYPES.put("", Typeface.NORMAL);
        TYPES.put("Bold", Typeface.BOLD);
        TYPES.put("Italic", Typeface.ITALIC);
        TYPES.put("Bold Italic", Typeface.BOLD_ITALIC);
    }
